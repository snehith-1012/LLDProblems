...
public class AudioMergingOperation implements Operation {

    private OperationData operationData;
    private Operation nextOperation;

    public AudioMergingOperation(OperationData operationData, Operation nextOperation) {
    ...
    private Audio modifyAudio(Audio audio, OperationData operationData) {
        System.out.println("merged at " + ((AudioMergingOperationData) operationData).getAudioMergeOperationData().get(0).toString() + " and " + ((AudioMergingOperationData) operationData).getAudioMergeOperationData().get(1).toString());
        return audio;
    }
}
