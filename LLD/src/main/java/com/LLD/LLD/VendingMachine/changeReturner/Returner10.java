...
public class Returner10 implements ChangeReturner {
    ...
    public Returner10(ChangeReturner nextChangeReturner) {
    ...
    public void returnChange(VendingMachine vendingMachine, int amount) {
        if (canHandle(amount)) {
            ...
            System.out.println("returning " + cnt + " 10 rupee number of notes");
