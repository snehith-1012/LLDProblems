...
public class CultFitDemo {
    ...
    public static void main(String[] args) {
        ...
        // add work out slots
        cultfit.addWorkoutSlotForAGym("3", WorkOutTypeEnum.YOGA, new Slot("1", 6, 7, 3));
        cultfit.addWorkoutSlotForAGym("3",WorkOutTypeEnum.YOGA, new Slot("3",10,11,1));
        cultfit.addWorkoutSlotForAGym("4", WorkOutTypeEnum.GYM, new Slot("2", 7, 8, 2));

        // display work out slots
        cultfit.displayWorkOutSlotsForAGym("3",WorkOutTypeEnum.YOGA);
        cultfit.displayWorkOutSlotsForAGym("4",WorkOutTypeEnum.GYM);

        // cancel work out slot
        cultfit.cancelWorkOutSlotForAGym("4",WorkOutTypeEnum.GYM,"2");
